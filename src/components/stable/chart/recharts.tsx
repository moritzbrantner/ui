...
function ChartContainer({
  ...
  config: ChartConfig;
  children: React.ComponentProps<typeof RechartsResponsiveContainer>["children"];
  initialDimension?: {
    width: number;
    height: number;
  };
...
export type ChartLegendContentProps = React.ComponentProps<typeof ChartLegendContent>;
...
export type ChartTooltipContentProps = React.ComponentProps<typeof ChartTooltipContent>;
