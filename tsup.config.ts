...
export default defineConfig({
  ...
  entry: {
    ...
    scholia: "src/scholia.ts",
    "scholia/server": "src/scholia-server.ts",
    pop: "src/pop.ts",
    "pop/server": "src/pop-server.ts",
    pulse: "src/pulse.ts",
    "pulse/server": "src/pulse-server.ts",
    ...
    "themes/scholia": "src/themes/scholia.tsx",
    "themes/pop": "src/themes/pop.tsx",
    "themes/pulse": "src/themes/pulse.tsx",
